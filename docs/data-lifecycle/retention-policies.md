...
Automatic execution is reserved for [Arc Enterprise](/arc-enterprise/automated-scheduling). In Arc OSS, retention policies must be manually triggered via the API.
:::
