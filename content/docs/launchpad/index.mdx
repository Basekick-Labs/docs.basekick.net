---
title: "Arc Launchpad"
description: "Self-hosted web console for Arc instances you already run: SQL editor, log viewer, monitoring, retention policies, continuous queries, alerts, MQTT ingestion, and token management."
---
