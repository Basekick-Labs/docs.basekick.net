...
description: "Install Arc Enterprise from the .deb, .rpm or Arch package, or build from source, then run it under systemd with a license key, storage backend, and cluster role in arc.toml."
---
...
<Tabs items={['Debian/Ubuntu', 'RHEL/Fedora', 'Source']}>
  <Tab value="Debian/Ubuntu">
