...
description: "Install Arc Enterprise from .deb or .rpm packages or build from source, then run it under systemd with a license key, storage backend, and cluster role in arc.toml."
---
...
<Tabs items={['Debian/Ubuntu', 'RHEL/Fedora', 'Build from Source']}>
