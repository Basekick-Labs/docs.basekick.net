...
description: Age Arc Enterprise data from hot storage to S3 Glacier or Azure Archive with per-database policies, and control retrieval behaviour when a query reaches cold-tier files.
---
...
<Tabs items={['AWS S3 / MinIO', 'Azure Blob Storage']}>
...
<Callout type="idea" title="Use Environment Variables for Secrets">
