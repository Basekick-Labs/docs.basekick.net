...
description: "Secure Arc Enterprise inter-node traffic with an HMAC-SHA256 shared secret for join authentication and TLS certificates for the coordinator, Raft, and replication transports."
---
...
<Callout type="idea" title="Recommended Configuration">
...
<Tabs items={['TOML', 'Environment Variables']}>
<Tab value="TOML">
...
<Callout type="warn" title="Secret Management">
...
<Callout type="idea" title="Kubernetes Deployments">
