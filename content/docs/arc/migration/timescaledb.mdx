...
<Callout type="idea" title="Migrate at your own pace">
...
<Callout type="warn" title="Convert the timestamp on export">
...
<Callout type="warn" title="Match the spine type to `time_bucket`">
