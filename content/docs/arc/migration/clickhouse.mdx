...
<Callout type="info" title="An honest note on query speed">
...
<Callout type="idea" title="Run both in parallel">
...
<Callout type="warn" title="Timestamps and timezones">
...
<Callout type="idea" title="Sizing and batching">
...
<Callout type="info" title="Quantiles differ by design">
