...
description: "Run Arc in Docker: pull the image, mount a data volume, capture the first-run admin token, point it at local, S3, MinIO, or Azure storage, and deploy with Docker Compose."
---
