---
title: "Arc OSS"
description: "Arc is an open, SQL-native time-series database on Parquet and object storage: ingest MessagePack or Line Protocol, query with standard SQL, and store data on local disk, S3, MinIO, or Azure Blob."
---
...
- [arcli](/arcli/) - The command line for Arc: connections, queries, writes, imports and admin without hand-written `curl`
