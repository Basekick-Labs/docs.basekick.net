---
title: "Query Caching"
description: "Arc's three query-path caches — SQL transform, partition path, and glob — what each memoizes, their TTLs, and why repeated dashboard queries benefit most."
---
