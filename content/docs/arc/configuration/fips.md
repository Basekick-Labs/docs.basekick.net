...
description: "The arc-fips build variant for regulated deployments: what it changes about Arc's cryptography, the GODEBUG settings it accepts, and what a compliance claim requires."
---
...
<Callout type="info" title="FIPS is a build variant, not a version">
...
<Callout type="info" title="GODEBUG: `fips140=only` vs `fips140=on`">
...
<Callout type="warn" title="Switching to `arc-fips` requires rotating all API tokens">
...
<Callout type="warn" title="Read this before making a compliance claim">
