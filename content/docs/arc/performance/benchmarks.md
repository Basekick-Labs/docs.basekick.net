...
- **[Arc on ClickBench](https://basekick.net/blog/arc-fastest-timeseries-database-clickbench)** — the headline results and how the runs were performed.
- **[Cold-run results](https://basekick.net/blog/arc-clickbench-cold-runs)** — query performance with caches flushed.
...
- [Arc vs InfluxDB](https://basekick.net/blog/arc-clickbench-vs-influxdb)
- [Arc vs TimescaleDB](https://basekick.net/blog/arc-clickbench-vs-timescaledb)
- [Arc vs DuckDB](https://basekick.net/blog/arc-clickbench-vs-duckdb)
- [Arc vs CrateDB](https://basekick.net/blog/arc-clickbench-vs-cratedb)
- [Arc vs StarRocks](https://basekick.net/blog/arc-clickbench-vs-starrocks)
- [Arc vs Elasticsearch](https://basekick.net/blog/arc-clickbench-vs-elasticsearch)

## Log workloads

- **[Arc log benchmark](https://basekick.net/blog/arc-log-benchmark-2026)** — ingestion and query performance on log-shaped data.
