---
title: "arcctl"
description: "The operator CLI for Arc: connection profiles, SQL queries, Line Protocol writes, database administration, and bulk import without hand-written curl calls."
---
...
- [Bulk import](/arc/cli/import/) — load CSV / LP / Parquet / TLE files into a database (admin-only)
