...
<Cards>
  <Card title="Connection management" href="/arc/cli/connections/" description="Add, switch, and override connection profiles." />
  <Card title="arcctl query" href="/arc/cli/query/" description="Run SQL with table, JSON, CSV, or Arrow output." />
  <Card title="Writing line protocol" href="/arc/cli/write/" description="Ingest from stdin or a file, with precision control." />
  <Card title="Database administration" href="/arc/cli/db/" description="List, show, create, and drop databases." />
  <Card title="Measurement listing" href="/arc/cli/measurement/" description="List the measurements within a database." />
  <Card title="Bulk import" href="/arc/cli/import/" description="Load CSV, LP, Parquet, or TLE files into a database (admin-only)." />
</Cards>
